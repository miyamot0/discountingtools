...
```{r dataFormatsLongWide, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r analyticalStrategySingle, message=FALSE, eval=FALSE, cache=TRUE}
...
```{r analyticalStrategyMultiple, message=FALSE, eval=FALSE, cache=TRUE}
...
```{r ed50Example, message=FALSE, eval=FALSE, cache=TRUE}
results = fitDDCurves(data = dataFrame.long,
                      settings = list(Delays     = Delay,
                                      Values     = Value,
                                      Individual = ids),
...
```{r mbaucExample, message=FALSE, eval=FALSE, cache=TRUE}
results = fitDDCurves(data = dataFrame.long,
                      settings = list(Delays     = Delay,
                                      Values     = Value,
                                      Individual = ids),
...
```{r log10MbaucExample, message=FALSE, eval=FALSE, cache=TRUE}
results = fitDDCurves(data = dataFrame.long,
                      settings = list(Delays     = Delay,
                                      Values     = Value,
                                      Individual = ids),
...
```{r screeningMethods, message=FALSE, eval=FALSE, cache=TRUE}
...
```{r screeningAndFilteringMethods, message=FALSE, eval=FALSE, cache=TRUE}
...
```{r visualizationData, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r visInd, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r visGrp, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r visGrpED50, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r visGrpMBAUC, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
...
```{r visGrpLog10MBAUC, fig.width=6, fig.height=6, warning=FALSE, message=FALSE}
